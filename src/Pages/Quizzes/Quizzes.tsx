...
import { CreateQuizModal, InfoQuizModal, JoinQuizModal } from './QuizzesModels';
...
const Quizzes = ({ }: IProps) => {
  ...
  return <>
    {CookieServices.get("role").role === "Instructor" ? <>
      <CreateQuizModal {...{ isOpen, closeModal, duration, questions_number, difficulty, type, openInfoModel }} />
        ...
        {CookieServices.get("role").role === "Instructor" ? <>
          ...
          <div className='flex flex-col flex-1 '>
            ...
            <div className="p-3 mt-2 overflow-x-auto border-2 rounded-md" >
              ...
              </div> : <div className='flex justify-between font-semibold  items-center'>
              ...
              <table className='w-full border-2 border-separate rounded-md mt-2 border-slate-400'>
                ...
                <tbody className='text-center text-gray-500 divide-y'>
                  ...
                  {allDataLoaded && CompletedQuizzes?.map(({ title, status, participants, schadule, closed_at, _id }: ICompletedQuizzes) => <tr key={_id} className='bg-white dark:border-gray-700 dark:bg-gray-800 hover:bg-blue-200'>
                    ...
                    <td className='py-3 border border-slate-300'><span className='p-1 tracking-wider font-medium  bg-red-200 text-red-800 rounded-full '>{status}</span></td>
